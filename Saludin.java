        ...
        void verificarTiposExpresion(Token operador, Token operando1, Token operando2) {
           ...
           String getCppType(Token tipo) {
               switch (tipo.kind) {
                   ...
                   case ARR: return "int"; // o el tipo que usas para arreglos
                   default: return "int";
               }
           }
...
cppCode.append(getCppType(tipo)+" "+id.image+" ");
    if (jj_2_19(3)) {
...
agregarVariable(id.image, tipo.image);
  ...
  final public String Expresion() throws ParseException {String t1, t2; Token op; String expr="";
    t1 = Termino();
expr=t1;
    label_2:
    while (true) {
...
{if ("" != null) return expr;}
  ...
  final public String Termino() throws ParseException {String t1, t2; Token op;String expr="";
    t1 = Factor();
expr=t1;
    label_3:
    while (true) {
...
etiquetaInicioWhile = genEtiqueta();
        ...
        cppCode.append("while (" + condicion + ") {\u005cn");
    BloqueSentencias();
...
cppCode.append("for (" + expInicio + "; " + expCondicion + "; " + expIncremento + ") {\u005cn");
    BloqueSentencias();
...
codeDirection("escribir", exp, "", "");
        cppCode.append("cout << " + exp + " << endl;\u005cn");
  }
